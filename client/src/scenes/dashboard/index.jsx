...
import { useGetDashboardQuery } from "state/api/mongoDBApi";
...
const Dashboard = () => {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <FlexBetween>
        <Header title="DAHSBOARD" subtitle="Welcome to Your Dashboard" />
        <Box>
          <Button
            sx={{
      ...
      >
        ...
        >
          ...
          >
            Breakdown of sales and revenue by category for this year and total
            sales.
          </Typography>
        </Box>
      </Box>
