MERN Based CMS Panel,

I am planning to create an admin panel, where you can integrate to different marketplaces and your ERP system

I will be using MERN for the developement purporses , but the MongoDB will be replaced by PostgreSQL database

you can check the demo from this link https://cms-mern-frontend.onrender.com/dashboard
